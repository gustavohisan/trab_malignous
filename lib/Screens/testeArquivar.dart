...
class TesteArquivar extends StatefulWidget {
  @override
  _TesteArquivar createState() {
    return _TesteArquivar();
  }
}

class _TesteArquivar extends State<TesteArquivar> {
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            if (_chaveForm.currentState.validate()) {
                              //isso e um teste so
                              arquivarPostagem(74).then((value) {
                                String texto;
                                if (value) {
                                  texto = "Deu certo";
                                } else {
